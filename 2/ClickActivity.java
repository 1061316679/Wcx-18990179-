...
//                Toast.makeText(ClickActivity.this,"您点击了组件"+((TextView) v).getText(),Toast.LENGTH_SHORT).show();
//            }
//        }
    }
...
//            if (v.getId()==R.id.button){
//                Toast.makeText(ClickActivity.this, "您长按了组件"+((TextView) v).getText(),Toast.LENGTH_SHORT).show();
//            }
//            return true;
//        }
//    }
