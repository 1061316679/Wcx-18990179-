...
import com.example.a20201021.util.DateUtil;
import com.example.a20201021.util.ViewUtil;
...
//    }
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990179 吴晨希"};
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 密码方式校验
                ...
                for (Map.Entry<String, Object> item_map : mapParam1.entrySet()) {
                    ...
                    et_phone.setText( shared1.getString(key, ""));
                    et_password.setText( shared1.getString(key, ""));
                }
